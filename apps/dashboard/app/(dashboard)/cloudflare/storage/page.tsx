...
const services = [
  { name: "R2", desc: "Egress-free object storage", icon: "🗄️", route: "/cloudflare/storage/r2", color: "bg-blue-500" },
  { name: "D1", desc: "Serverless SQL database", icon: "🗃️", route: "/cloudflare/storage/d1", color: "bg-indigo-500" },
  { name: "KV", desc: "Ultra-fast key-value storage", icon: "🔑", route: "/cloudflare/storage/kv", color: "bg-yellow-500" },
  { name: "Queues", desc: "Message processing at scale", icon: "📨", route: "/cloudflare/storage/queues", color: "bg-purple-500" },
  { name: "Hyperdrive", desc: "Global database acceleration", icon: "🚀", route: "/cloudflare/storage/hyperdrive", color: "bg-cyan-500" },
  { name: "Cache Reserve", desc: "Persistent caching for static content", icon: "💨", route: "/cloudflare/storage/cache-reserve", color: "bg-green-500" },
  { name: "Artifacts", desc: "Git-native versioned storage", icon: "📦", route: "/cloudflare/storage/artifacts", color: "bg-orange-500" },
  { name: "Data Platform", desc: "Ingest, catalog & query", icon: "📊", route: "/cloudflare/storage/data-platform", color: "bg-rose-500" },
];
