...
const hostingNav = [
  ...
  { href: "/dashboard/env-vars", label: "Environment Variables", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
  ...
  { href: "/dashboard/vps/container-service", label: "Container Services", icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" },
  { href: "/dashboard/vps/create", label: "New Instance", icon: "M12 6v6m0 0v6m0-6h6m-6 0H6" },
...
const networkNav = [
  ...
  { href: "/dashboard/cloudflare/network", label: "DNS Management", icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
];
...
const servicesNav = [
  ...
  { href: "/dashboard/services/support-tickets", label: "Support", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  { href: "/dashboard/services/affiliates", label: "Affiliates", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857" },
...
const supabaseNav = [
  { href: "/dashboard/supabase", label: "Supabase", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
...
const automationNav = [
  ...
  { href: "/dashboard/git/accounts", label: "Git Accounts", icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
  ...
  { href: "/dashboard/hostinger/n8n", label: "n8n Automation", icon: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" },
];
...
const adminNav = [
  ...
  { href: "/dashboard/admin/marketplace", label: "Marketplace Admin", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
];
      ...
      <aside className={`${sidebarOpen ? "w-64" : "w-0"} bg-white border-r border-gray-200 flex-shrink-0 transition-all duration-300 overflow-hidden`}>
        <div className="h-full flex flex-col">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            {renderNavGroup("Network & Domains", networkNav, pathname)}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50">
          <div className="bg-amber-50 border-b border-amber-200 px-6 py-2 text-xs text-amber-700 flex items-center gap-2">
            ...
            <span>Data shown is pre-populated for demonstration. Connect a provider in <strong>Settings → Integrations</strong> to provision real infrastructure.</span>
          </div>
          <div className="p-6">
            {children}
          </div>
