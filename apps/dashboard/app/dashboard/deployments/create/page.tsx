  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (activeTab === "upload") {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/deployments/upload`, {
          method: "POST",
      ...
      if (deploymentId) {
        await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/deployments/${deploymentId}/deploy`, {
          method: "POST",
          headers: { Authorization: `Bearer ${token}` },
        }).catch(() => {});
      }
