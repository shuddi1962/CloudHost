...
export default function PHPSettingsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/hosting/account/00000000-0000-0000-0000-000000000000/php-settings`, { headers }).then(r => r.json()),
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/hosting/php-info`, { headers }).then(r => r.json()),
  ...
  const save = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    const token = localStorage.getItem("token");
    await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/hosting/account/00000000-0000-0000-0000-000000000000/php-settings`, {
      method: "PUT",
