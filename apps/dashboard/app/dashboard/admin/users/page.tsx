...
const demoUsers = [
  ...
  { id: "9", name: "Rachel Green", email: "rachel@fashion.co", isAdmin: false, isSuperAdmin: false, createdAt: "2026-06-01T09:00:00Z" },
  { id: "10", name: "David Kim", email: "david@saaspro.com", isAdmin: false, isSuperAdmin: false, createdAt: "2026-06-10T11:30:00Z" },
  { id: "11", name: "Anna Schmidt", email: "anna@eurohost.de", isAdmin: false, isSuperAdmin: false, createdAt: "2026-06-22T15:45:00Z" },
  { id: "12", name: "James Wilson", email: "james@devops.io", isAdmin: true, isSuperAdmin: false, createdAt: "2026-07-01T08:15:00Z" },
];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <span className="badge badge-info">{users.filter((u: any) => !u.isAdmin && !u.isSuperAdmin).length} Users</span>
          <span className="badge badge-warning">{users.filter((u: any) => u.isAdmin && !u.isSuperAdmin).length} Admins</span>
          <span className="badge bg-red-100 text-red-700">{users.filter((u: any) => u.isSuperAdmin).length} Super Admins</span>
        </div>
      </div>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {u.isSuperAdmin && <span className="badge bg-red-100 text-red-700 text-[10px]">Super Admin</span>}
                          {u.isAdmin && !u.isSuperAdmin && <span className="badge badge-warning text-[10px]">Admin</span>}
                        </div>
                      </div>
                    </td>
                    <td className="p-4 text-gray-600">{u.email}</td>
                    <td className="p-4">
                      <select defaultValue={u.isSuperAdmin ? "super_admin" : u.isAdmin ? "admin" : "user"}
