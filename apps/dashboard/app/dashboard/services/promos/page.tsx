...
export default function PromosPage() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/marketing-suite/promos`, { headers })
      .then(r => r.json())
  ...
  const redeem = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/marketing-suite/promos/redeem`, {
        method: "POST", headers,
