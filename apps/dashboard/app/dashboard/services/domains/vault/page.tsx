...
export default function DomainVaultPage() {
  ...
  const fetchVault = async () => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/domain-services/vault`, { headers });
  ...
  const addToVault = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/domain-services/vault`, {
      method: "POST", headers,
  ...
  const requestUnlock = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/domain-services/vault/${unlockModal}/unlock`, {
      method: "POST", headers,
  ...
  const approveUnlock = async (id: string) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/domain-services/vault/${id}/approve-unlock`, {
      method: "POST", headers,
    });
    if (res.ok) {
      const data = await res.json();
